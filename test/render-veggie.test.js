...
test('renders a veggie', assert => {
    ...
    const expected = '<li id="spinach" class="veggie-box"><div>Baby Spinach</div><img id="image" src="../data/spinach.png" alt="Baby Spinach image"><p class="price">$1.00<button id="spinach">Add to Cart</button></p></li>';
